...
最终实际调用共 10 次，供应商 usage 为输入 22013、输出 18726、合计 40739 token。完整结果、基线对比、边界和人工评审入口见[验收记录](../../document-question-quality-validation.md)。上述协议勾选项包含离线验证，实际模型重出题路径未触发，不能据此宣称该路径已做真实验收。
