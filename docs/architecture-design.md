...
- 版本：0.2
- 日期：2026-09-16
- 状态：设计基线；I1 工程与协议基础、I2 配置与版本管理已实现，逐卡证据见 tasks/i1.md 与 tasks/i2.md，其余能力仍为目标设计
...
以下为协议设计，统一 `/api/v1` 前缀；服务、环境和加载接口已由 I2 实现，runs 接口仍待 I3/I4。JSON 字段使用 camelCase，内部 Python 字段可用 snake_case 并从契约统一导出别名。
