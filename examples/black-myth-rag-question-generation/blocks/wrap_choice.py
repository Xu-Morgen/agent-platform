...
@block(id='rag-question-wrap-choice', version='2.0.0', name='封装单选题', description='主数据 Choice；参考 tuple[()]；输出 QuestionEnvelope。')
def run(value: NodeInput[Choice, tuple[()]]) -> QuestionEnvelope:
    try:
