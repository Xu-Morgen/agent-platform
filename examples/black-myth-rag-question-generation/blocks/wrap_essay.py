...
@block(id='rag-question-wrap-essay', version='1.0.0', name='封装论述题', description='主数据 Essay；参考 tuple[()]；输出 QuestionEnvelope。')
def run(value: NodeInput[Essay, tuple[()]]) -> QuestionEnvelope:
