...
从 [文档导航](docs/README.md) 查看产品、架构和使用手册；当前能力与未完成边界统一见 [产品说明](docs/product-requirements.md)。全部计划及阶段验收记录已退役至 [历史归档](docs/archive/README.md)，仅用于追溯，不作为当前实施入口或新版验收结论。
...
| `docs/` | 产品、架构、手册和协议；计划与历史资料集中在 `docs/archive/` |
