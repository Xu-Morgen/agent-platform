...
contextBridge.exposeInMainWorld('agentPlatform', Object.freeze({
  ...
  ocrModels: () => ipcRenderer.invoke('platform:ocrModels'),
  ocrSelection: () => ipcRenderer.invoke('platform:ocrSelection'),
  selectOCR: (body) => ipcRenderer.invoke('platform:selectOCR', body),
  importOCR: (body) => ipcRenderer.invoke('platform:importOCR', body),
  checkOCR: (id) => ipcRenderer.invoke('platform:checkOCR', id),
  ocrJob: (id) => ipcRenderer.invoke('platform:ocrJob', id),
