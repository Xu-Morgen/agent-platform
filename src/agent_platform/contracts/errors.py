...
ErrorCode = Literal[
    'OCR_NOT_SELECTED', 'OCR_NOT_READY', 'OCR_INCOMPATIBLE',
    'OCR_INPUT_LIMIT', 'OCR_INFERENCE_ERROR', 'OCR_CAPACITY_EXCEEDED',
    'EMBEDDING_NOT_SELECTED', 'EMBEDDING_NOT_READY', 'EMBEDDING_INCOMPATIBLE',
    'EMBEDDING_INPUT_LIMIT', 'EMBEDDING_INFERENCE_ERROR', 'EMBEDDING_CAPACITY_EXCEEDED',
    'KNOWLEDGE_NOT_FOUND', 'KNOWLEDGE_ARCHIVED', 'KNOWLEDGE_SCOPE_ERROR', 'KNOWLEDGE_LIMIT_EXCEEDED',
    'DOCUMENT_CORRUPTED',
    'DOCUMENT_READ_ERROR', 'DOCUMENT_LIMIT_EXCEEDED', 'PACKAGE_INPUT_INSUFFICIENT', 'MODEL_CONTEXT_EXCEEDED',
    'PREPARATION_CANCELLED', 'PREPARATION_TIMEOUT', 'PREPARATION_URL_ERROR', 'PREPARATION_NETWORK_ERROR',
    'PREPARATION_HASH_MISMATCH', 'PREPARATION_DISK_FULL', 'DEPENDENCY_CONFLICT', 'DEPENDENCY_WHEEL_UNAVAILABLE',
    'BLOCK_TIMEOUT', 'BLOCK_PROCESS_ERROR',
    'FILE_NOT_FOUND', 'FILE_REFERENCE_INVALID', 'FILE_FORMAT_UNSUPPORTED', 'FILE_TOO_LARGE', 'FILE_SAVE_FAILED',
    ...
    'BACKEND_UNAVAILABLE', 'STARTUP_ERROR', 'APPLICATION_EXIT', 'APPLICATION_INTERRUPTED', 'STORAGE_ERROR',
]
